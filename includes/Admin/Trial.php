...
if ( ! class_exists( 'Trial' ) ) {
    final class Trial {
        ...
        public function __construct() {
            ...
            $this->prefix = 'whols'; 
            $this->pro_file = 'whols-pro/whols-pro.php';
            $this->data_center = 'https://feed.hasthemes.com/whols/tw/';
            $this->initial_page = 'admin.php?page=whols-admin';
            $this->screen_ids =  array('edit-whols_user_request', 'edit-whols_role_cat', 'toplevel_page_whols-admin', 'whols_page_whols_recommendations');
        ...
        public function header_script() {
            ...
            /* Custom CSS */
            body.taxonomy-whols_role_cat .htiop-bar-notice,
            body.post-type-whols_user_request .htiop-bar-notice{
                width: 100%;
